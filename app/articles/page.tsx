      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-muted-foreground mb-12 max-w-3xl">
            Explore my thoughts, insights, and tutorials on data analysis,
            visualization, and more. These articles reflect my experiences and
            learnings in the field of data science.
          </p>
              ...
              .map((article) => (
                ...
                >
                  <div className="relative h-48 w-full">
                    <Image
                      src={
                        article.image || "/placeholder.svg?height=200&width=400"
                      }
                      alt={article.title}
                      fill
